...
#Table of Results
columnName = c("Number of Degree","FPR","FNR", "Accuracy", "AUC Score", "F1 Score", "F2 Score", "Remarks") 
...
f1 = 2 * ((precision*recall)/(precision+recall))
f2 = 5 * ((precision*recall)/((4*precision)+recall))
results.df[nrow(results.df)+1,] = c(2,fpr,fnr,acc,auc,f1,f2,"Without CV")
results.df
...
f1 = 2 * ((precision*recall)/(precision+recall))
f2 = 5 * ((precision*recall)/((4*precision)+recall))
results.df[nrow(results.df)+1,] = c(3,fpr,fnr,acc,auc,f1,f2,"Without CV")
results.df
...
f1 = 2 * ((precision*recall)/(precision+recall))
f2 = 5 * ((precision*recall)/((4*precision)+recall))
results.df[nrow(results.df)+1,] = c(4,fpr,fnr,acc,auc,f1,f2,"Without CV")
results.df
...
f1 = 2 * ((precision*recall)/(precision+recall))
f2 = 5 * ((precision*recall)/((4*precision)+recall))
results.df[nrow(results.df)+1,] = c(1,fpr,fnr,acc,auc,f1,f2,"With CV")
results.df
